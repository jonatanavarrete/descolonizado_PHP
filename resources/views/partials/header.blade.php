<svg class="hidden">
	...
	<header class="sections__header">
					<h1 class="title">Descolonizado</h1>
				</header>
			
				<!-- menu -->
				{{--<nav class="menu">
					<ul class="menu__inner">
						<li class="menu__item"><a class="menu__item-link" href="#">Sobre mi</a></li>
						<li class="menu__item"><a class="menu__item-link" href="#">Qué se hacer</a></li>
						<li class="menu__item"><a class="menu__item-link" href="#">Blog</a></li>
